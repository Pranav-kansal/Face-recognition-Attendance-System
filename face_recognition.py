...
class facedetect:
    def __init__(self,root):
        ...
        img = Image.open(r"C:\Users\PRANAV KANSAL\Desktop\face recognition\facedetect.png")
    ...
    def face_recog(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbours,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                my_cursor.execute("Select name from student where studentId="+str(ids))
                n = my_cursor.fetchone()
                n = "+".join(n)

                my_cursor.execute("Select rollno from student where studentId=" + str(ids))
